...
class GastoFijo(Base):
    ...
    monto_mensual: Mapped[float] = mapped_column(DECIMAL(12, 2), nullable=False)  # Monto en la moneda especificada
    moneda: Mapped[MonedaGasto] = mapped_column(Enum(MonedaGasto), default=MonedaGasto.ARS, nullable=False)  # Moneda del gasto
    monto_mensual_ars: Mapped[Optional[float]] = mapped_column(DECIMAL(12, 2))  # Calculado automáticamente para compatibilidad
