#!/usr/bin/env python3
"""
Ultra-simple FastAPI backend for testing login
"""
...
# FastAPI app
app = FastAPI(
    title="DentiProject Backend (Simple Test)",
    description="Simple backend for testing login without bcrypt",
    version="1.0.0"
)
...
@app.get("/")
def root():
    return {"message": "DentiProject Backend is running!", "status": "ok"}
...
def get_consultas_mock(limit: int = 25, order_by: str = "fecha"):
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Starting Simple DentiProject Backend...")
